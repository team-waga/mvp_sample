...
import { Coffee, ShieldCheck, QrCode, Package, ArrowRight, Database, Leaf, Linkedin, Twitter } from "lucide-react"
    ...
    <div className="flex flex-col gap-8 pb-20 w-full max-w-full mx-auto">
      ...
      <div className="mt-12 flex justify-center gap-4">
        <a
          ...
          className="text-slate-600 hover:text-blue-500 transition-colors p-2"
          aria-label="Telegram"
        >
          <svg
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-slate-600 hover:text-blue-700 transition-colors p-2"
          aria-label="LinkedIn"
        >
          <Linkedin size={24} />
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-slate-600 hover:text-sky-600 transition-colors p-2"
          aria-label="Twitter"
        >
          <Twitter size={24} />
        </a>
